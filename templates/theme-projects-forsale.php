<?php
/* Template Name: Template - Projects for sale */
get_header(); ?>
    ...
    <div class="projects-page-filter-menu">
      ...
      <a class="projects-page-filter-empty" href="<?php echo esc_url( home_url( '/venta-departamentos' ) ); ?>">
        ...
        <svg class="_icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          <path d="M10.0002 11.1666L5.91683 15.2499C5.76405 15.4027 5.56961 15.4791 5.3335 15.4791C5.09738 15.4791 4.90294 15.4027 4.75016 15.2499C4.59738 15.0971 4.521 14.9027 4.521 14.6666C4.521 14.4305 4.59738 14.236 4.75016 14.0833L8.8335 9.99992L4.75016 5.91659C4.59738 5.76381 4.521 5.56936 4.521 5.33325C4.521 5.09714 4.59738 4.9027 4.75016 4.74992C4.90294 4.59714 5.09738 4.52075 5.3335 4.52075C5.56961 4.52075 5.76405 4.59714 5.91683 4.74992L10.0002 8.83325L14.0835 4.74992C14.2363 4.59714 14.4307 4.52075 14.6668 4.52075C14.9029 4.52075 15.0974 4.59714 15.2502 4.74992C15.4029 4.9027 15.4793 5.09714 15.4793 5.33325C15.4793 5.56936 15.4029 5.76381 15.2502 5.91659L11.1668 9.99992L15.2502 14.0833C15.4029 14.236 15.4793 14.4305 15.4793 14.6666C15.4793 14.9027 15.4029 15.0971 15.2502 15.2499C15.0974 15.4027 14.9029 15.4791 14.6668 15.4791C14.4307 15.4791 14.2363 15.4027 14.0835 15.2499L10.0002 11.1666Z" fill="#2C2C2C"/>
        </svg>
      </a>
      <?php endif; ?>
      <div class="projects-page-filter-selects">
      <?php 
        $terms_district = get_terms("distrito-proyecto");
        if (!empty($terms_district)): ?>
        <div class="projects-page-filter-select select--type2 general-input --select --right">
          <div class="general-input-inside">
            <div class="general-input-ico --right">
      ...
      <?php 
        $terms_category = get_terms("categoria-proyecto");
...
// Filtro por categoria-proyecto
if (!empty($_GET['categoria-proyecto'])) {
  $tax_queries[] = array(
    'taxonomy' => 'categoria-proyecto',
    'field'    => 'slug',
    'terms'    => sanitize_text_field($_GET['categoria-proyecto']),
  );
  ++$cont;
}
